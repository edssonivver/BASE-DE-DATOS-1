...
{
    public partial class VGPersonalGerentes : Form
    {
        PersonalGerenteBD pg = new PersonalGerenteBD();


        public VGPersonalGerentes()
        {
            InitializeComponent();
        }
        ...
        private void dgvPersonalGerente_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
